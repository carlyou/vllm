...
class MLAAttentionNvfp4QuantPattern(MLAAttentionQuantPattern):
    ...
    def _register(self, pm_pass: PatternMatcherPass) -> None:
        ...
        inputs = [
            empty_bf16(5, self.num_heads, self.qk_head_dim),  # q
            empty_bf16(5, self.kv_lora_rank),  # kv_c_normed
            empty_bf16(5, 1, self.qk_rope_head_dim),  # k_pe
            empty_bf16(5, self.output_dim),  # output_attn
